"""
Django settings for SamberiPriceCheckerProject project.
...
ROOT_URLCONF = 'SamberiPriceCheckerProject.urls'
...
WSGI_APPLICATION = 'SamberiPriceCheckerProject.wsgi.application'
