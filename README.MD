**SamberiPriceChecker** - простое Django-приложение для отслеживания динамики цен на сайте https://shop.samberi.com/. В качестве БД - Postgres, Celery + Redis для ежедневного парсинга новых данных о ценах.
